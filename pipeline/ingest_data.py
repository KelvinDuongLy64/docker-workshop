...
@click.option('--year', default=2021, type=int, show_default=True, help='Year of the taxi dataset')
@click.option('--month', default=1, type=int, show_default=True, help='Month of the taxi dataset')
@click.option('--target-table', default='yellow_taxi_data', show_default=True, help='Target PostgreSQL table name')
@click.option('--chunksize', default=100000, type=int, show_default=True, help='Rows per chunk when reading CSV')
def run(
    pg_user,
    pg_pass,
    pg_host,
